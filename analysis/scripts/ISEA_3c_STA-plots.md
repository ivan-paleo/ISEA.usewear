...
```
    ...
    other attached packages:
     ...
     [9] tidyverse_2.0.0    rmarkdown_2.29     RColorBrewer_1.1-3 R.utils_2.12.3    
    [13] R.oo_1.27.0        R.methodsS3_1.8.2  knitr_1.49         gridExtra_2.3     
    [17] grateful_0.2.10    factoextra_1.0.7   ggplot2_3.5.1      doBy_4.6.24       

    loaded via a namespace (and not attached):
     [1] gtable_0.3.6         xfun_0.49            bslib_0.8.0         
     [4] rstatix_0.7.2        ggrepel_0.9.6        lattice_0.22-6      
     [7] tzdb_0.4.0           vctrs_0.6.5          tools_4.4.2         
    [10] generics_0.1.3       pkgconfig_2.0.3      Matrix_1.7-1        
    [13] lifecycle_1.0.4      compiler_4.4.2       farver_2.1.2        
    [16] textshaping_0.4.1    microbenchmark_1.5.0 munsell_0.5.1       
    [19] carData_3.0-5        htmltools_0.5.8.1    sass_0.4.9          
    [22] yaml_2.3.10          Formula_1.2-5        car_3.1-3           
    [25] ggpubr_0.6.0         pillar_1.10.0        crayon_1.5.3        
    [28] jquerylib_0.1.4      MASS_7.3-63          cachem_1.1.0        
    [31] abind_1.4-8          boot_1.3-31          Deriv_4.1.6         
    ...
    [43] cli_3.6.3            magrittr_2.0.3       broom_1.0.7         
    [46] withr_3.0.2          scales_1.3.0         backports_1.5.0     
    [49] timechange_0.3.0     modelr_0.1.11        ggsignif_0.6.4      
    [52] ragg_1.3.3           hms_1.1.3            evaluate_1.0.1      
